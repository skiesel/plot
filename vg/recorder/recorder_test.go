...
var want = []string{
	...
	`Scale(1, 2)`,
	`Rotate(0.72)`,
	`github.com/skiesel/plot/vg/recorder/recorder_test.go:22 Stroke(vg.Path{vg.PathComp{Type:0, X:3, Y:4, Radius:0, Start:0, Angle:0}})`,
	`github.com/skiesel/plot/vg/recorder/recorder_test.go:23 Push()`,
	`github.com/skiesel/plot/vg/recorder/recorder_test.go:24 Pop()`,
	`github.com/skiesel/plot/vg/recorder/recorder_test.go:25 Translate(3, 4)`,
	`SetLineWidth(100)`,
